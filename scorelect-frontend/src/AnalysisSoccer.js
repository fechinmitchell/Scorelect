...
const DatasetAnalysis = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // Allow both free and premium users when permission is set to 1
      if (
        (perm === 1 && userRole !== 'free' && userRole !== 'premium') ||
      ...
      return {
        ...
        gameData: (game.gameData || []).map(tag => {
          ...
          if (analysisType === 'video') {
            ...
            // Normalize coordinates to match the analysis dashboard's 105×68 meter pitch
  ...
  const options = [
    {
      ...
      onClick: () => navigate('/soccer-pitch', { state: { newSession: true, setupTeam: true } })
    },
    {
      id: 'skip-setup',
      title: 'Skip Setup',
      ...
      onClick: () => navigate('/soccer-pitch', { state: { newSession: true, skipSetup: true } })
    }
  ];
    ...
    ? [
        {
          ...
          onClick: () => navigate('/soccer-pitch', { state: { newSession: true, loadTemplate: true } })
        }
      ]
    : [
        {
...
// --- Main AnalysisSoccer Component ---
const AnalysisSoccer = ({ onSportSelect, selectedSport, defaultTab }) => {
  const [activeTab, setActiveTab] = useState(defaultTab === 'video' ? 1 : 0);
    ...
    <div className="analysis-container">
      ...
      <div className="analysis-header">
        ...
        <p className="analysis-subtitle">
          Track, analyze, and visualize performance metrics for your soccer matches.
        </p>
      </div>
...
AnalysisSoccer.defaultProps = {
    onSportSelect: () => {},
    selectedSport: 'Soccer',
    defaultTab: null
  };
  
  export default AnalysisSoccer;
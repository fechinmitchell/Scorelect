  ...
  const steps = [
    {
      ...
      description:
        'Navigate to the sidebar and choose Gaelic Football or Hurling from the drop-down menu.',
      image: "", // Add your image path here
    },
    {
      label: '2. Click on Action Button then on the Field to Record Event',
      description:
        'In the instructions section, click on an action button like "Goal" or "Assist". Then, click on the specific location on the field where the event occurred.',
      image: "", // Add your image path here
    },
    {
